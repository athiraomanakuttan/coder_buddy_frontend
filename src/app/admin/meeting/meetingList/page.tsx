   ...
   console.log("meetingData",meetingData)
    ...
    return (
        <div className="m-0 p-0 flex">
            ...
            <button className={`${meetingStatus === 1 && 'bg-adminprimary text-white' } border rounded  pl-3 pr-3 pt-2 pb-2`} onClick={()=>setStatus(0)}>Scheduled</button>   
            <button className={` ${meetingStatus === 0 && 'bg-adminprimary text-white' }border rounded pl-3 pr-3 pt-2 pb-2`} onClick={()=>setStatus(1)}>History</button>
            </div>   
                 <TableComponent
