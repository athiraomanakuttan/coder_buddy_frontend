...
const meetingPage = () => {
    ...
    const heading = ["title", "meetingDate"]
  ...
  return (
    ...
    {meetingDetails.length === 0 ?(status === 0 ?<> No Scheduled Meetings </> :<> No Meeting history </>):<><ListComponent headings={heading} listData={meetingDetails} /></>}
